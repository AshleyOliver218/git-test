...
for (let counter = 0; counter < solarSystem.length; counter++) {
    if(solarSystem[counter].ringSystem == true){
    console.log(solarSystem[counter])
}
...
// 3. console.log the sum of the number of satellites of Jupiter, Saturn, Uranus, and Neptune (131)
    // let satSum = Object.vallues.system(jupiter.satellites) + (Object.vallues.system(saturn.satellites))
...
let mercRadP = system.mercury.radiusp
console.log(mercRadP)
