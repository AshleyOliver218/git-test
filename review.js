...
let hungry = 4
console.log(`I want ${hungry} ${e}${food}'s`)
// ================ Variable Names =================
/* 
...
let myFriend = "sabrina"
console.log(myFriend.charAt(4))
// Define Unicode in a comment, and get the Unicode using charCodeAt() of the third character in Teddy
//unique identifyers assigned to represent universal language symbols.
let bear = "Teddy" 
let smokey = bear.charCodeAt(2)
console.log(smokey)
// Using fromCharCode() - make it readable for us :). You'll see!
// console.log(bear.fromCharCode())*********************************************************
...
let sentence = "Baby Amani has perfect attendence!"
        if(sentence.startsWith("Baby")){
          console.log("True")
        }else{
          console.log("False")
        }
// Now use any variable with endsWith() and return false
        if(sentence.endsWith("perfect")){
          console.log("True")
        }else{
          console.log("False")
        }
